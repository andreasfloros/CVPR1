...
function [matchedPoints1, matchedPoints2] = get_matched_points(I1, I2, auto, taskn)
    if auto
        % detectHarrisFeatures, detectSURFFeatures, detectKAZEFeatures...
        ...
        % change the MatchThreshold to control quantity of correspondences
        indexPairs = matchFeatures(features1,features2,MatchThreshold=100.0);
